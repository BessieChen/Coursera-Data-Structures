...
class DisjointSet(object):
    def __init__(self, n, lines):
        ...
        self.lines = [0] + lines
        self.rank = [0] * (n + 1)
        self.parent = list(range(0, n + 1)) #the first parent is itself
    ...
    def get_parent(self, x):
        ...
        while root != self.parent[root]:
            print("root", root)
            print("self.parent[root]", self.parent[root])
    ...
    def merge(self, dest, src):
        ...
        print("self.rank[src_root]",self.rank[src_root],"self.rank[dest_root]",self.rank[dest_root])
